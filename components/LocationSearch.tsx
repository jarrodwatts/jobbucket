...
export default function GoogleMaps({
  ...
  setLocationValue: React.Dispatch<SetStateAction<PlaceType | null>>;
}) {
  ...
  if (typeof window !== "undefined" && !loaded.current) {
    if (!document.querySelector("#google-maps")) {
      loadScript(
        "https://maps.googleapis.com/maps/api/js?key=AIzaSyB-FfZWTE6eyFTnZ6jZoJPvfNYlR4HwQ2M&libraries=places",
